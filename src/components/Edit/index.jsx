...
const Edit = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const url = id
      ? `https://example.com/api/datas/${id}`
      : "https://example.com/api/datas";
    fetch(url, {
      method,
    })
      .then(() => {
  ...
  return (
    <>
      <UserEdit
        data={users}
        OnSubmitFormUser={handleSubmit}
        onChange={handleChange}
      />
      <SuitEdit OnSubmitFormSuit={handleSubmit} onChange={handleChange} />
      <InstrumentEdit
        OnSubmitFormInstrument={handleSubmit}
        onChange={handleChange}
      />
    </>
  );
